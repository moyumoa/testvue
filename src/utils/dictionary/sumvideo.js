...
ELEMENT_ORIGIN.add(3, '', '素材库上传')
ELEMENT_ORIGIN.add(6, '', '云素材')
...
ELEMENT_ORIGIN.add(30, '', '素材合并')
ELEMENT_ORIGIN.add(31, '', '素材拆分')
...
WORK_USEWAY.add(2, '', '成片库下载') // 下载-老数据
WORK_USEWAY.add(21, '', '成片库下载')
