  ...
  <div class="team_data">
    ...
    <div class="table_box">
      ...
      >
        ...
        <el-table-column label="核销门店" prop="poiName">
          <template #default="scope">
            <div>{{ scope.row.poiName || '--' }}</div>
          </template>
        </el-table-column>
          ...
          <template #default="scope">
            <div class="round_warp">
              <div
                class="round"
                :class="{
                  orderStatus_100: scope.row.itemStatus == 100,
                  orderStatus_300: scope.row.itemStatus == 300,
                  orderStatus_301: scope.row.itemStatus == 301,
                  orderStatus_401: scope.row.itemStatus == 401
                }"
              ></div>
              {{ scope.row.itemStatusStr || '--' }}
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column label="券核销时间" prop="verifyTime">
          <template #default="scope">
            <div>{{ scope.row.verifyTime || '--' }}</div>
          </template>
        </el-table-column>
      </xm_table>
    </div>
...
const { searchComponents, getList, tableForm, exportFiles } = pageList('coupons')
