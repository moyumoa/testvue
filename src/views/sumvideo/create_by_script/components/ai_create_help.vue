    ...
    <div class="ai_content" ref="contentRef">
      ...
      >
        ...
        <div class="message_item message_item_user" v-if="item.type == 1 && item.result">
          <div class="title">好的，我了解啦！下面是我根据你的要求写的脚本：</div>
...
const messageList = ref([
  {
    ...
    content:
      'Hi，我叫麦麦～我是短视频脚本创作大师，也是视频拍摄专家！我可以给你一些脚本的建议，请告诉我本次短视频的对象是？例如：沙发、洗碗机、运动鞋...',
    result: null, // 生成结果
