  ...
  <div>
    ...
    >
      <div class="dialog_content">
        ...
        >
          <el-form-item label="素材名称：" prop="name" v-if="type === 'merge'">
            <el-input
              show-word-limit
...
function tipsContent(type) {
  const tipsSet = {
    merge: '合并后会按照勾选顺序生成一条新的视频素材，并且原视频素材依然保留。',
    disassemble:
      '按照下方设置的拆分时长对素材进行拆条，拆条出的每一条视频为一条新的视频素材，并且原视频素材依然保留。'
  }
  return tipsSet[type] || ''
}
