  ...
  >
    <div class="page_top flex_c" :style="{ paddingBottom: pageData.enableBgm ? 0 : '12px' }">
      ...
      <div class="top_r flex_c" v-if="pageData.enableBgm">
        <el-button type="primary" class="mar_top_12" @click="importFun">从素材库选择</el-button>
...
const delMaterialFun = throttle(function () {
  ...
  ElMessageBox.confirm(
    ...
    }的素材中删除所选素材？<br/><span style="line-height: 30px;font-size:13px;color:#606266">注：不会刪除素材库中对应的素材</span>`,
    '刪除素材',
    {
