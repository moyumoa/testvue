<template>
  ...
  >
    ...
    <div class="match_material_content">
      ...
      <!-- <div class="item_line">
        <span class="label">过滤已使用的素材</span>
...
// const filterUsed = ref(true) // 是否过滤已使用素材
...
function importFn() {
  ...
  const params = {
    ...
    resourceType: 0, // 资源类别 0素材库资源 3音色 6普通文本转音频，默认0，仅音频分镜导入文本素材时传6
    isSelectAll: true,
    excludeResourceIds: []
  }
