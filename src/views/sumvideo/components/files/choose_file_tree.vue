...
const props = defineProps({
  origin: {
    type: String,
    default: '' // material 素材库 finishProduct 成片库 productScene 商品场景 productShoot 实拍图
  },
  rootTitle: {
    type: String,
    default: ''
...
function renameSuccessFun(pid, ppid) {
  loading.value = true
  // 重命名成功 如果当前选中的文件夹ID和重命名的文件夹ID一致，就刷新素材/成片列表
