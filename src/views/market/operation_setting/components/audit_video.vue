<template>
  <div class="msgsetting">
            ...
            <div>
              ...
              <div style="display: flex">
                <p
                  ...
                  "
                >
                  {{ `开启后，有内容需要审核时，系统将在客户端给相关审核人员推送通知` }}
                </p>
    ...
    <!-- 视频审核设置 -->
    <!-- <section style="padding: 28px 24px 25px 24px">
      <div
        style="
          display: flex;
    ...
    <!-- <el-dialog
      v-model="addMemberShow"
      @close="clear"
      :title="member.nodeId ? '添加审核人' : '添加审核节点'"
      width="30%"
    >
      <el-form ref="formRef" @submit.enter.prevent>
        <el-form-item label="搜索成员">
      ...
      <div style="border-top: 1px solid #dcdee0; margin-top: 24px">
        <p
          style="
            margin-top: 24px;
            height: 24px;
    ...
    <!-- 删除节点弹窗 -->
    <!-- <el-dialog v-model="deleteNodeShow.show" title="系统提醒" width="30%">
