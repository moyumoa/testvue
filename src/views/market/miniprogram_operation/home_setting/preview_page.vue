  ...
  <div class="preview_page">
    ...
    <div class="preview_content">
      ...
      <div class="content_brand">
        <img
          class="brand_logo"
          :style="brandRetainLogo ? 'width:114px;height:32px;' : 'margin-right:2px'"
          :src="brandRetainLogo || brandLogo"
          alt=""
        />
      ...
      <div
        :class="{
          content_content: true,
          content_content_noHover: [3].includes(systemVersion) && [1, 3].includes(miniViewMode)
        }"
      >
...
const brandLogo = ref('https://tagvv-1256030678.file.myqcloud.com/202506097fa1m.png')
