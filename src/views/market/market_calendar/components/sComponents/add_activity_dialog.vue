...
const getList = () => {
  ...
  data.taskStatuses = [3, 4, 5, 7]
  data.taskTypes = [1, 2, 6] // 直播和视频任务
  data.isActivityData = 1
  data.isActivity = 0 // 过滤掉已关联的任务
  data.taskGroup = 1 // 只查询KOS任务
  // 活动的开始时间和结束时间字段也要传过去
