                ...
                <div class="qrcode_box" v-if="row.qrCode" style="padding: 25px 0">
                  ...
                  <div class="qr_mark">
                    ...
                    <span style="font-size: 14px; font-weight: bold">
                      <span v-if="row.taskGroup == 3">微信</span>
                      <span v-else-if="architectureMode === 3 || architectureMode === 4">企微</span>
                      <span v-else-if="row.taskGroup == 5">微信</span>
...
const taskTypeEnums = {
  ...
  collection: {
    ...
    successCountTips: ['有审核通过的素材/视频'],
    finishCountTips: ['有审核成功的素材/视频'],
    numberOfPeopleTips: [
      '已分发人数：任务实际已经分发到的人数 ',
      '注：因组织架构及人员变动，“已分发人数”与“预计分发人数”可能不一致；',
      '系统会在任务开始前48h左右触发补偿机制，保证任务能覆盖到归属部门下的所有达人'
