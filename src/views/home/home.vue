  ...
  <div class="home_wrapper" @click="hidden">
    ...
    <div class="home_container">
      <div class="form_wrap">
        ...
        <div
          v-if="belongValue === 1"
          class="form_item"
          :class="showPipeline ? 'form_item_active' : ''"
          @click.stop="clickPipeline"
        >
          <div class="input_wrap">
            <span>流水线</span>
            <b></b>
          ...
          <div v-if="showPipeline" class="pipeline_wrap" @click.stop>
            <div class="search_wrap">
              ...
              <img
                class="clear_img"
                src="@/assets/imgs/clear-icon.png"
                alt=""
              />
            </div>
        ...
        <div
          class="form_item"
          :class="showCreat ? 'form_item_active' : ''"
    ...
    <div v-if="showTipDialog" class="tip_dialog" @click.stop>
      <div class="dialog_head">
        <span>提示</span>
        <img
          src="@/assets/imgs/del-dialog.png"
          alt=""
            ...
            api
              ...
              .then(() => {
                ...
                this.loadingPercent = Math.round(
                  (uploadIndex / allLength).toFixed(2) * 100
                );
