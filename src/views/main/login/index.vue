<template>
  <div class="page_layout login_page_self" v-loading="loading">
    ...
    <img class="login_title" src="@/assets/images/login/top_title.png" alt />
    <div class="login_page_self_main">
      ...
      <div class="right">
        <div class="right-center">
          <div class="right_title">星麦云·企业内容矩阵经营工作台</div>
          <chooseBrand
          ...
          >
            <template #cancelBtn>
              <el-button class="cancel_btn" style="margin-left: 0" @click="backFun">
                返回上一步
              </el-button>
            </template>
          </chooseBrand>
          <div class="right-container" v-else>
            ...
            <div class="right_tips">Version 7.0</div>
          </div>
        </div>
      </div>
    </div>
...
.login_page_self {
  ...
  .login_back {
    ...
    .login_LT {
      ...
      width: 1223px;
      height: 100%;
      background: radial-gradient(farthest-corner at 0 0, #dee8f8, #fff 70%, #ffffff);
    }
