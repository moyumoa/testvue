<template>
  <div class="fs_setting_wrapper mt_16">
    <div class="fs_setting_header g_bg">
      ...
      <p class="text1">利用企业微信基础能力（组织架构）进行全员内容创作</p>
      <p class="text2">
        {{
          showSystemName()
        }}支持企业微信平台，同步企业微信组织架构，便捷管理各部门员工进行矩阵营销任务分发，建立企业私域流量池
      </p>
    </div>
    <div class="fs_setting_main g_bg mt_16">
      <div class="form">
        <div class="form_item">
          <div class="form_item_label">企业微信id：</div>
          <div class="form_item_content">
            <el-input v-model="code" disabled style="width: 400px" @blur="onBlur" />
          </div>
        </div>
        <div class="form_item" v-if="!judgeOEA()">
        ...
        <!-- <div class="form_item" style="margin-top: -10px">
          ...
          <div class="form_item_content">
            ...
            <p class="tip">开启后，未注册员工可在企业微信上打开应用，自动注册</p>
          </div>
        </div> -->
        ...
        <!-- <div class="form_item" style="margin-top: -10px" v-if="autoRegister">
    ...
    <el-dialog v-model="visible" title="设置" width="500px" :before-close="onClose">
      <div>
        <span class="red_start">角色：</span>
        ...
        <div class="gray_tip">请设置企业微信员工的默认角色</div>
      </div>
      <!-- <div class="mt_16">
        <span>是否需要绑定手机号：</span>
