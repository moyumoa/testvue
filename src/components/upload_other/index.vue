...
function beforeUpload(file) {
  ...
  if (
    ...
    !props.acceptTypeList.includes('.' + suffix.toLowerCase())
  ) {
    ElMessage.error(`不支持${suffix}格式文件`)
    return false
  }
  if (!maxSize.value) {
